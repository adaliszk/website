---
slug: minecraft-server-mesh
title: Minecraft Server Mesh
description: >-
    Extension for Minecraft and Velocity servers to mesh the instances with seamless transition between
    identical server nodes.
stage: idea
year: 12024
sourceLink: https://github.com/adaliszk/minecraft-meshing
tags:
  - Alpine-Linux
  - Docker
  - Bash
