---
slug: minecraft-dedicated-server
title: Minecraft Server
description: Lightweight, secure, and optimized Minecraft Server container with Kubernetes, Helm, and Prometheus support.
stage: idea
year: 12024
sourceLink: https://github.com/adaliszk/minecraft-server
tags:
  - Alpine-Linux
  - Docker
  - Bash
